...
const timelineData = [
  ...
  },
  {
    ...
    back: '第一次收到戒指，是她给的。在第20天的晚上，我们像往常一样在楼下散步。聊着聊着天，她忽然把手伸进口袋里，掏出一个东西，然后趁我不注意拉过我的手就往上套。我低头一看，是一枚戒指。她也没看我，就继续往前走，说“早就买了，一直在等一个合适的时机”。我追上去拉住她的袖子，不知道该说什么。那枚戒指就安安静静地戴在我手上，像她这个人一样，没有多好听的话，但做了就是做了。',
    photo: 'photos/03.jpg'
  },
  {
    date: '2023.12.14',
  ...
  },
  {
    ...
    back: '今天是我们的第188天，正好赶上我们的第一个520哦！我准备了一束玩偶花，想着你之前说过喜欢可爱的毛茸茸的东西，我还挑了一个你最喜欢的颜色。你递给我的时候我还没反应过来，直到看到你手里也有东西——是一个手工相框，你做的，里面放着我们的照片。那天我们俩站在那儿，手里都拿着给对方的东西，我突然觉得，这就是我想要的那种幸福。',
    photo: 'photos/05.jpg'
  },
  {
    date: '2024.11.14',
    ...
    back: '今天是我们在一起的第366天呢。我们去买了一个小蛋糕，没有很隆重，就是一起挑了一个我们俩都喜欢的口味。切蛋糕的时候我忽然有点恍惚，觉得上次我们还在过一个月纪念日，怎么一转眼就一年了。但看着你坐在对面吃蛋糕的样子，又觉得这一年不长不短，刚刚好。蛋糕很甜，但你笑起来比蛋糕还甜。我心想，如果以后的每一年都能这样过，那我真的别无所求了。',
    photo: 'photos/06.jpg'
  },
  {
    date: '2025.04.17',
  ...
  },
  {
    ...
    back: '我们两周年啦，那时我们还在异地。我没法陪在你身边，只能给你点了一个你喜欢的蛋糕和一份礼物。你拆开的时候已经很小心了，结果还是把蛋糕的一个角碰掉了。你发来消息：“完了完了，我把蛋糕的一个脚搞没了”，后面跟着一个哭哭的表情。我说没关系，你说“我就是个小捣蛋鬼”。我对着屏幕笑了很久。异地没办法一起切蛋糕，但看你隔着屏幕笨手笨脚的样子，还是很可爱。那个少了一角的蛋糕，反而让这一天更有温度，更像我们。',
    photo: 'photos/08.jpg'
  },
  {
    date: '2026.08.10',
...
const dailyData = [
  {
    ...
    story: '读大学的时候，我经常不吃早餐，觉得多睡一会儿比较重要。她知道了以后，每次都说“不吃早餐对身体不好”，然后开始每天给我带早餐。一开始我还有点不好意思，后来慢慢就习惯了。早餐有时候是在网上买的牛奶面包，有时候是她在食堂买包子豆浆。就这样，她包了我大学三年的早餐。毕业以后每次想起来，都觉得那三年被她照顾得很好。她从来没有说过什么动人的情话，但她用一千多个早晨告诉我，她是真的在意我。',
    date: '2023-2026',
